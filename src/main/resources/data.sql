 ...
 */
--roles
INSERT INTO ROLE(ROLE_ID,ROLE_NAME,ROLE_DESCRIPTION) VALUES(1,'ADMIN','Admin Role');
INSERT INTO ROLE(ROLE_ID,ROLE_NAME,ROLE_DESCRIPTION) VALUES(2,'EMPLOYEE','Employee Role');
INSERT INTO ROLE(ROLE_ID,ROLE_NAME,ROLE_DESCRIPTION) VALUES(3,'CUSTOMER','Customer Role');
...
and r.ROLE_ID=1;
INSERT INTO USER_ROLE(USER_ID,ROLE_ID) SELECT a.USER_ID,r.ROLE_ID FROM USER_T a,ROLE r WHERE a.USERNAME='adam_klient'
and r.ROLE_ID=3;
...
--customers
INSERT INTO CUSTOMER(FIRST_NAME,LAST_NAME,CUSTOMER_PHONE,CUSTOMER_EMAIL,USER_ID)
